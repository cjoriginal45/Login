...
public class RolJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = null;
     ...
     public RolJpaController(){
       emf =  Persistence.createEntityManagerFactory("Login_pers");
    }
    ...
    public void create(Rol rol) {
        ...
        try {
            ...
            for (Usuario listaUsuariosUsuarioToAttach : rol.getListaUsuarios()) {
                listaUsuariosUsuarioToAttach = em.getReference(listaUsuariosUsuarioToAttach.getClass(), listaUsuariosUsuarioToAttach.getNombre());
    ...
    public void edit(Rol rol) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            for (Usuario listaUsuariosNewUsuarioToAttach : listaUsuariosNew) {
                listaUsuariosNewUsuarioToAttach = em.getReference(listaUsuariosNewUsuarioToAttach.getClass(), listaUsuariosNewUsuarioToAttach.getNombre());
